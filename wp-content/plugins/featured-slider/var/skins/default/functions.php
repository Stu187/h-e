<?php 
function featured_post_processor_default($posts, $featured_slider_curr,$out_echo,$set,$data=array()){
	$skin='default'; 
	...
	foreach($posts as $post) { 
		...
		$html = apply_filters('featured_slideri_start',$html,$post_id,$featured_slider_curr,$featured_slider_css,$set,$data);	
		$cleardiv='<div class="sldr_clearlt"></div><div class="sldr_clearrt"></div>';	
		if($featured_slider_curr['block_pos']=='0') {
			if($mod == 0) {
				$html.= featured_construct_html($post,$featured_slider_curr,$featured_slider_css,$set,$data,0,0);
				$right_close ='';
			}
			else if($mod == 1) { 
				$html.= '<div class="featured_slide_right">'; 
				$html.= featured_construct_html($post,$featured_slider_curr,$featured_slider_css,$set,$data,1,0);
				$right_close ='</div>';
			}
			else if($mod == 4) { 
				$html.= featured_construct_html($post,$featured_slider_curr,$featured_slider_css,$set,$data,1,0).$right_close;
			}
			else { 
				$html.= featured_construct_html($post,$featured_slider_curr,$featured_slider_css,$set,$data,1,0); 
			}
	...
	if($right_close != '' && $mod != 4 && $featured_slider_curr['block_pos']=='0') $html .= $right_close;
	...
	//filter hook
	$html=apply_filters('featured_extract_html',$html,$featured_sldr_j,$posts,$featured_slider_curr,$skin);
	if($out_echo == '1') {
	   echo $html;
	}
...
function featured_construct_html($post,$featured_slider_curr,$featured_slider_css,$set,$data,$slide_type,$processor) {
	$id = $post_id = '';
	...
	//filter hook
	$slider_excerpt=apply_filters('featured_slide_excerpt_html',$slider_excerpt,$post_id,$featured_slider_curr,$featured_slider_css,$data);
...
function featured_data_processor_default($slides, $featured_slider_curr,$out_echo,$set,$data=array()){
	$skin='default'; 
	$default_featured_slider_settings=get_featured_slider_default_settings();
	$featured_slider_css = featured_get_inline_css($set);
	$html = '';
	$featured_sldr_j = $i = $mod = 0;
	$right_close=$page_close='';	
	$featured_slider_curr= populate_featured_current($featured_slider_curr);
	...
	foreach($slides as $slide) {
		...
		$cleardiv='<div class="sldr_clearlt"></div><div class="sldr_clearrt"></div>';
	 	if($featured_slider_curr['block_pos']=='0') {
			if($mod == 0) {
				$html.= featured_construct_html($slide,$featured_slider_curr,$featured_slider_css,$set,$data,0,1);
				$right_close ='';
			}
			else if($mod == 1) { 
				$html.= '<div class="featured_slide_right">'; 
				$html.= featured_construct_html($slide,$featured_slider_curr,$featured_slider_css,$set,$data,1,1);
				$right_close ='</div>';
			}
			else if($mod == 4) { 
				$html.= featured_construct_html($slide,$featured_slider_curr,$featured_slider_css,$set,$data,1,1).$right_close;
			}
			else { 
				$html.= featured_construct_html($slide,$featured_slider_curr,$featured_slider_css,$set,$data,1,1); 
			}
	...
	//filter hook
	$html=apply_filters('featured_extract_html',$html,$featured_sldr_j,$slides,$featured_slider_curr,$skin);
	if($out_echo == '1') {
	   echo $html;
	}
	$r_array = array( $featured_sldr_j, $html);
...
/***-------------------------------------------------------------------------------------------------------***/
function featured_slider_get_default($slider_handle,$r_array,$featured_slider_curr,$set,$echo='1',$data=array()){
	$skin='default';
 ...
 * ---------------------------------------------------------------------------------------------
 **/
function featured_slideri_start_filter($html,$id,$featured_slider_curr,$featured_slider_css,$set,$data) {
	$type = isset($data['type'])?$data['type']:'';
	/**
	 * ---------------------------------------------------------------------------------------------
...
add_filter('featured_slideri_start', 'featured_slideri_start_filter',10,6);

function featured_slide_excerpt_html_filter($slider_excerpt,$id,$featured_slider_curr,$featured_slider_css,$data) {
	$type = isset($data['type'])?$data['type']:'';
	/**
	 * ---------------------------------------------------------------------------------------------
...
add_filter('featured_slide_excerpt_html', 'featured_slide_excerpt_html_filter',10,6);
?>
