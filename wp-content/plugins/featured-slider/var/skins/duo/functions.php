<?php 
function featured_post_processor_duo($posts, $featured_slider_curr,$out_echo,$set,$data=array()){
	$skin='duo'; 
	...
	foreach($posts as $post) { 
		...
		$html = apply_filters('featured_slideri_start_duo',$html,$post_id,$featured_slider_curr,$featured_slider_css,$set,$data);	
		$cleardiv='<div class="sldr_clearlt"></div><div class="sldr_clearrt"></div>';	
		if($featured_slider_curr['block_pos']=='0') {
			if($mod == 0) {
				$html.= featured_duo_construct_html($post,$featured_slider_curr,$featured_slider_css,$set,$data,0,0);
				$right_close ='';
			}
			else if($mod == 1) { 
				$html.= '<div class="featured_slide_right">'; 
				$html.= featured_duo_construct_html($post,$featured_slider_curr,$featured_slider_css,$set,$data,1,0);
				$right_close ='</div>';
			}
			else if($mod == 2) { 
				$html.= featured_duo_construct_html($post,$featured_slider_curr,$featured_slider_css,$set,$data,1,0).$right_close;
			}
		}
	...
	if($right_close != '' && $mod != 2 && $featured_slider_curr['block_pos']=='0') $html .= $right_close;
	...
	//filter hook
	$html=apply_filters('featured_extract_html_duo',$html,$featured_sldr_j,$posts,$featured_slider_curr,$skin);
	if($out_echo == '1') {
	   echo $html;
	}
...
function featured_duo_construct_html($post,$featured_slider_curr,$featured_slider_css,$set,$data,$slide_type,$processor) {
	$id = $post_id = '';
	...
	//filter hook
	$slider_excerpt=apply_filters('featured_slide_excerpt_html_duo',$slider_excerpt,$post_id,$featured_slider_curr,$featured_slider_css,$data);
	...
	if($slide_type == 1) {
		...
		$html .= '<div class="featured_slide_sub_right" '.$featured_slider_css['slide_sub_right'].' >';
		if ($featured_slider_curr['image_only'] == '0') $html.= $cnt_comeents;
		$html.= $imgvideo;
		if ($featured_slider_curr['image_only'] == '0')
...
function featured_data_processor_duo($slides, $featured_slider_curr,$out_echo,$set,$data=array()){
	$skin='duo'; 
	$default_featured_slider_settings=get_featured_slider_default_settings();
	$featured_slider_css = featured_get_inline_css($set);
	$html = '';
	...
	foreach($slides as $slide) {
		...
		$cleardiv='<div class="sldr_clearlt"></div><div class="sldr_clearrt"></div>';
	 	if($featured_slider_curr['block_pos']=='0') {
			if($mod == 0) {
				$html.= featured_duo_construct_html($slide,$featured_slider_curr,$featured_slider_css,$set,$data,0,1);
				$right_close ='';
			}
			else if($mod == 1) { 
				$html.= '<div class="featured_slide_right">'; 
				$html.= featured_duo_construct_html($slide,$featured_slider_curr,$featured_slider_css,$set,$data,1,1);
				$right_close ='</div>';
			}
			else if($mod == 2) { 
				$html.= featured_duo_construct_html($slide,$featured_slider_curr,$featured_slider_css,$set,$data,1,1).$right_close;
			}
		}
		if($featured_slider_curr['block_pos']=='1') {
			if($mod == 1) {
	...
	//filter hook
	$html=apply_filters('featured_extract_html_duo',$html,$featured_sldr_j,$slides,$featured_slider_curr,$skin);
	if($out_echo == '1') {
	   echo $html;
	}
	$r_array = array( $featured_sldr_j, $html);
...
/***-------------------------------------------------------------------------------------------------------***/
function featured_slider_get_duo($slider_handle,$r_array,$featured_slider_curr,$set,$echo='1',$data=array()){
	$skin='duo';
 ...
 * ---------------------------------------------------------------------------------------------
 **/
function featured_slideri_start_filter_duo($html,$id,$featured_slider_curr,$featured_slider_css,$set,$data) {
	$type = isset($data['type'])?$data['type']:'';
	/**
	 * ---------------------------------------------------------------------------------------------
...
add_filter('featured_slideri_start_duo', 'featured_slideri_start_filter_duo',10,6);

function featured_slide_excerpt_html_filter_duo($slider_excerpt,$id,$featured_slider_curr,$featured_slider_css,$data) {
	$type = isset($data['type'])?$data['type']:'';
	/**
	 * ---------------------------------------------------------------------------------------------
...
add_filter('featured_slide_excerpt_html_duo', 'featured_slide_excerpt_html_filter_duo',10,6);
?>
